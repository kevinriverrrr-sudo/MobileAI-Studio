...
interface IModelRepository {
    ...
    suspend fun searchHuggingFace(query: String, filter: String?, sort: String, limit: Int): List<ModelSearchDto>
    ...
    suspend fun getRecommendedModels(capabilities: DeviceCapabilities): List<ModelSearchDto>
}
